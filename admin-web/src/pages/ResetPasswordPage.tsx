        ...
        <div className="px-8 py-7">
          ...
          >
            ...
            <p className="font-mono text-[10px] text-adm-t3 leading-relaxed">
              The link you followed is missing or malformed.<br />
      ...
      <div className="px-8 py-7">
        {(status === 'error' || errorMsg) && (
          ...
          >
            ...
            <button
              onClick={() => navigate('/admin/login')}
              className="mt-1.5 font-mono text-[9px] uppercase tracking-[0.1em] text-adm-amber hover:opacity-80 transition-opacity"
            >
              Request a new reset →
            </button>
          </motion.div>
